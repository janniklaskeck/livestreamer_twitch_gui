 ...
 * <p>
 * Please visit the PircBot homepage at <a href=
 * "http://www.jibble.org/pircbot.php">http://www.jibble.org/pircbot.php</a> for
 * full revision history, a beginners guide to creating your first PircBot and a
 * list of some existing Java IRC bots and clients that use the PircBot
 * framework.
 *
...
public abstract class PircBot implements ReplyConstants {
    ...
    private Hashtable<String, Hashtable<String, User>> channels = new Hashtable<>();

    // A Hashtable to temporarily store channel topics when we join them
    // until we find out who set that topic.
    private Hashtable<String, String> topics = new Hashtable<>();
    ...
    private String version = "PircBot " + VERSION + " Java IRC Bot - www.jibble.org";
    ...
    public String toString() {
        return "Version{" + version + "}" + " Connected{" + isConnected() + "}" + " Server{" + server + "}" + " Port{"
    ...
    public final User[] getUsers(String channel) {
        ...
        synchronized (channels) {
            Hashtable<String, User> users = channels.get(channel);
            if (users != null) {
    ...
    public final String[] getChannels() {
        ...
        synchronized (channels) {
            channels = new String[this.channels.size()];
    ...
    private final void removeUser(String nick) {
        synchronized (channels) {
            Enumeration<String> enumeration = channels.keys();
